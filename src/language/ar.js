export const arabic = {
  ...
  "Register as seller and open shop in ZijemuMart to start your business":
    "سجل كبائع ومتجر مفتوح في ZijemuMart لبدء عملك",
  ...
  eBusiness: "Ebusiness",
  Solution: "حل",
  "ZijemuMart is a Laravel and Flutter Framework-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business functionality.":
    "ZijemuMart عبارة عن نظام توصيل متعدد البائعين ، والبقالة ، والتجارة الإلكترونية ، والتجارة الإلكترونية ، والتجارة الإلكترونية ، والطرز ، ونظام توصيل الصيدلة ، ZijemuMart عبارة عن نظام توصيل الصيدلة ، وتجارة الإلكترون ، والتجارة الإلكترونية ، والطرد ، ونظام توصيل الصيدلة. لديها ست وحدات لتغطية جميع وظائف عملك.",
